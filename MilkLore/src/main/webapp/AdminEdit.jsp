            ...
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item dropdown ms-2">
                       ...
                       role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <c:choose>
                            <c:when test="${not empty dto.profilePath}">
                                <img src="uploads/${dto.profilePath}" alt="Profile" class="rounded-circle"
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                        ...
                        <li><a class="dropdown-item text-danger" href="toIndex"><i class="bi bi-box-arrow-right me-2"></i>Logout</a></li>
                    </ul>
                </li>
            </ul>
        </div>
            ...
            <div class="col-lg-8">
                <div class="profile-card p-4 p-md-5 mb-4">
                    <div class="d-flex align-items-center mb-4">
                        <!-- ✅ Profile Icon in profile card -->
                        <c:choose>
                            <c:when test="${not empty dto.profilePath}">
                                <img src="uploads/${dto.profilePath}" alt="Profile" class="rounded-circle me-3"
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 mb-4 mb-lg-0">
                <h5>Milklore</h5>
                <p class="small">Tales and Taste of Tradition. Bringing you the finest dairy products with a touch of
                    heritage.</p>
            </div>
            ...
            <form action="AdminEdit" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="adminName" name="adminName" value="${dto.adminName}">
                    </div>

                    <!-- Email (Read Only) -->
                    <div class="mb-3">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" class="form-control bg-light" id="email" name="email" value="${dto.email}" readonly>
                    </div>

                    <!-- Mobile Number -->
                    <div class="mb-3">
                        <label for="mobileNumber" class="form-label">Mobile Number</label>
                        <input type="tel" class="form-control" id="mobileNumber" name="mobileNumber" value="${dto.mobileNumber}">
                    </div>
